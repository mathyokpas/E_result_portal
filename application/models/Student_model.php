...
// The function below update student category //
    ...
    function createNewStudent(){
        ...
        $page_data = array(
            'name'          => html_escape($this->input->post('name')),
            'application_number'=> html_escape($this->input->post('application_number')),
            ...
            'section_id'      => html_escape($this->input->post('exam_id')),
...
public function promote_student($student_id, $new_class_id, $new_exam_id)
{
    $data = array(
