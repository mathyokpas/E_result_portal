...
class Student_payment_model extends CI_Model { 
	...
	function __construct(){
        ...
        function createStudentSinglePaymentFunction (){
            ...
            $page_data['invoice_number']    =   html_escape($this->input->post('invoice_number')) + rand(10000, 1000000). 'INV'. date('Y');
            ...
            $page_data2['amount_paid']    =   html_escape($this->input->post('amount_paid'));
            $page_data2['discount']     =   html_escape($this->input->post('discount'));
            $page_data2['timestamp']    =   html_escape($this->input->post('timestamp'));
