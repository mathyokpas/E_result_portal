           ...
           ?>
			...
			<?php echo form_open(base_url() . 'teacher/student_marksheet_subject/'. $exam_id . '/' . $class_id);?>
						<tr>
                                            ...
                                            <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['total_score'];?>" name="total_score_<?php echo $student_selected_with_class['student_id'];?>" onchange="total_score_change()">
											</td>
                                            <td><?php
