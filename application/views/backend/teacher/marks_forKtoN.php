		...
		<div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('Enter Student Score SHEET');?></div>
                <div class="panel-body table-responsive">
                	...
                	<?php echo form_open(base_url() . 'admin/marks_forKtoN' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
	...
	<div class="col-sm-12">
    					...
    					<table cellpadding="0" cellspacing="0" border="0" class="table">
								<thead>
									<tr>
										...
										<td><?php echo get_phrase('1st C.A.(20)');?></td>
										<td><?php echo get_phrase('2nd C.A.(20)');?></td>
									
										<td><?php echo get_phrase('exam score (60)');?></td>
                                        <td><?php echo get_phrase('total score(100)');?></td>
        ...
        <?php $select_subject_with_class_id  =   $this->crud_model->get_subjects_by_class($class_id);
           ...
           ?>
			...
			<?php echo form_open(base_url() . 'admin/marks_forKtoN/'. $exam_id . '/' . $class_id);?>
						<tr>
											<td>
...
?></td>
                                            ...
                                            <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['class_average'];?>" name="class_average_<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_average_change()" onkeyup="AddInputs()">
											</td>
...
function low_in_class_change() {
  var low_in_class = document.getElementsByClassName('low_in_class');
