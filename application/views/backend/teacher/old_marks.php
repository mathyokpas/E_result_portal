           ...
           ?>
			...
			<?php echo form_open(base_url() . 'teacher/marks/'. $exam_id . '/' . $class_id);?>
						<tr>
                                            ...
                                            <td>
								            <?php echo $general_select['exam_score'] + $general_select['class_score1'] + $general_select['class_score2'];?>
							</td>
                            <td><?php
$total_score = $general_select['exam_score'] +  $general_select['class_score1'] + $general_select['class_score2'];;

if ($total_score >=90)
{
	$grade = "A";
}
else if($total_score >=89.9)
{
	$grade = "B+";
}
else if($total_score >=79.9)
{
	$grade = "B";
}
else if($total_score >=69.9)
{
	$grade = "C";
}
else if($total_score >=59.9)
{
	$grade = "D";
}
else
...
?></td>
        ...
        <?php 
            endforeach;
                endforeach;
        ?>
          <tr><td colspan="3">Number of times school opened:</td><td colspan="3">
                     <input type="number" class="class_score form-control" value="<?php echo $general_select['total_attendance'];?>" name="total_attendance_" onchange="class_score_change()" onkeyup="AddInputs()">
                     </td>
                     <td colspan="3">Number of times attended:</td>
                     <td colspan="3"><input type="number" class="class_score form-control" value="<?php echo $general_select['attendance'];?>" name="attendance_" onchange="class_score_change()" onkeyup="AddInputs()">
                                        </td>
                                         <td colspan="3">Number of times abscent:</td>
                     <td colspan="3"><input type="number" class="class_score form-control" value="<?php echo $general_select['no_of_abscent'];?>" name="no_of_abscents_" onchange="class_score_change()" onkeyup="AddInputs()">
                                        </td>
                    </tr>
                    <tr><td colspan="3">Total Scores</td><td colspan="3">
                     <input type="number" class="class_score form-control" value="<?php echo $general_select['total_scores'];?>" name="total_scores_" onchange="class_score_change()" onkeyup="AddInputs()">
                     </td>
                     <td colspan="3">Average Scores</td>
                     <td colspan="3"><input type="number" class="class_score form-control" value="<?php echo $general_select['average_scores'];?>" name="average_scores_" onchange="class_score_change()" onkeyup="AddInputs()">
                                        </td>
                    </tr>
                    <tr><td colspan="3">Class Average</td><td colspan="3">
                     <input type="number" class="class_score form-control" value="<?php echo $general_select['class_average'];?>" name="class_average_" onchange="class_score_change()" onkeyup="AddInputs()">
                     </td>
                     </tr>
                    <tr><td colspan="3">Lowest_in_class</td><td colspan="3">
                     <input type="number" class="class_score form-control" value="<?php echo $general_select['lowest_in_class'];?>" name="lowest_in_class_" onchange="class_score_change()" onkeyup="AddInputs()">
                     </td>
                     <td colspan="3">Highest_in_class</td>
                     <td colspan="3"><input type="number" class="class_score form-control" value="<?php echo $general_select['highest_in_class'];?>" name="highest_in_class_" onchange="class_score_change()" onkeyup="AddInputs()">
                                        </td>
                    </tr>
                    ...
                    <tr><td colspan="3">Head Teacher's comment:</td> <td colspan="9">
        ...
        <tr ><td colspan="3">Next term begins:</td> <td colspan="9" border="2">
              ...
              <h5 id="error_message" class="alert alert-warning" style="display:none">Class score must not be greater 10 and exam score must not be greater than 70 and total score must not be greater than 100</h5>
