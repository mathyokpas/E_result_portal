    ...
    <?php echo form_open(base_url() . 'admin/student_payment/single_invoice' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="title" / required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="section_id" id="class_id" class="form-control select2" onchange="return get_class_student(this.value)">
                                        <option value=""><?php echo get_phrase('select_section_/_term');?></option>
			...
			<div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <option value="1">Fully_Paid</option>
                    <option value="2">Unpaid</option>
                    <option value="3">part_payment</option>
                   </select>
