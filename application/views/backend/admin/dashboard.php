                        ...
                        <div class="white-box stat-tile stat-c1">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Total Students');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php 
                                ...
                                $expense_amount = $query->row()->amount;?>
                                    <h4>
                                    <?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?> <?php echo $income_amount - $expense_amount;?>
                                    </h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12">
                        <div class="white-box panel-card panel-c2">
                            <div class="stats-row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="white-box panel-card panel-c3">
                            <h3 class="box-title m-b-0"><?php echo get_phrase('Recently Added Teachers Now');?></h3>
                    ...
                    <div class="col-sm-6">
                        <div class="white-box panel-card panel-c4">
