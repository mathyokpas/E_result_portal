...
<table id="example" class="table display">
                    ...
                    foreach($students as $key => $student):?>         
                        ...
                        <!--    <td><?php echo $student['roll'];?></td> -->
                            <td><?php echo $student['application_number'];?></td>
					...
					<a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>admin/promote_student/<?php echo $student['student_id']; ?>');">
    <button type="button" class="btn btn-success btn-circle btn-xs" title="Promote Student">
