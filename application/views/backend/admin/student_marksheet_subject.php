...
<div class="row">
    <div class="col-sm-12">
		<div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('Enter Student Score now');?></div>
...
?>
                                            ...
                                            <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['class_average'];?>" name="high_in_class_<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_average_change()" onkeyup="AddInputs()">
											</td>
        ...
        ?>
              ...
              <h5 id="error_message" class="alert alert-warning" style="display:none">C.A. score must not be greater 20 and exam score must not be greater than 60 and total score must not be more than 100</h5>
