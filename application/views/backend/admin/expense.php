  ...
  <div class="row">
		...
		<select name="expense_category_id" class="form-control select2" required>
			...
			<div class="form-group">
                    ...
                    <div class="col-sm-12">
		<input class="form-control m-r-10" name="timestamp" type="date" placeholder="yy-mm-dd" value="<?php echo date('Y-m-d'); ?>" id="example-date-input" required>
				</div>
				</div>
 ...
 <div class="row">
    ...
    <?php 
            ...
            <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_expense/<?php echo $row['payment_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
            <a onclick="confirm_modal('<?php echo base_url();?>expense/expense/delete/<?php echo $row['payment_id'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
