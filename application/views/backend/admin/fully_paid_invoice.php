<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('fully_payed_invoices');?></div>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo get_phrase('fully_payed');?></td>
							...
							<td><?php echo $row['amount'] - $row['amount_paid'];?></td>
							<td>
                            <span class="label label-<?php if($row['due']=='0')echo 'success'; elseif ($row['status']=='2') echo 'danger'; else echo 'warning';?>">
                            <?php if($row ['due'] == '0'):?>
                            <?php echo 'fully_Paid';?>
                            <?php endif;?>
