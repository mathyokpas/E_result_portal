 ...
 <div class="row">
        ...
        <?php echo form_open(base_url() . 'admin/student_payment/update_invoice/'. $row['invoice_id'], array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        ...
                        <select name="student_id" class="form-control select2" style="width:100%;" >
                            ...
                            ?>
                                <option value="<?php echo $row2['student_id'];?>"
                                    ...
                                    application_number <?php echo $row2['application_number'];?> -
                                    <?php echo $row2['name'];?>
                                </option>
                            <?php
                            endforeach;
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="status" class="form-control select2" style="width:100%">
                            <option value="1" <?php if($row['status']== '1')echo 'selected';?>><?php echo get_phrase('fully_paid');?></option>
                            <option value="2" <?php if($row['status']== '2')echo 'selected';?>><?php echo get_phrase('unpaid');?></option>
                            <option value="3" <?php if($row['status']== '3')echo 'selected';?>><?php echo get_phrase('part_payment');?></option>
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-12">
							<input class="form-control m-r-10" name="date" type="date" value="<?php echo $row['timestamp']; ?>" id="example-date-input" required>
                    </div>
