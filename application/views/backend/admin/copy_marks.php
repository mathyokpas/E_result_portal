           ...
           ?>
			...
			<?php echo form_open(base_url() . 'admin/marks/'. $exam_id . '/' . $class_id);?>
						<tr>
                                            ...
                                            <td>
								            <?php echo $general_select['exam_score'] + $general_select['class_score3'] + $general_select['class_score4'] + $general_select['class_score1'] + $general_select['class_score2'];?>
							                </td>
                                            <td><?php
$total_score = $general_select['exam_score'] + $general_select['class_score3'] + $general_select['class_score4'] + $general_select['class_score1'] + $general_select['class_score2'];;
    					...
    					<table cellpadding="0" cellspacing="0" border="0" class="table">
								<thead>
									<tr>
										...
										<td><?php echo get_phrase('creativity');?></td>
										<td><?php echo get_phrase('honesty');?></td>
										<td><?php echo get_phrase('neatness');?></td>
                                        <td><?php echo get_phrase('punctuality');?></td>
										<td><?php echo get_phrase('relationship_with_peers');?></td>
                                        <td><?php echo get_phrase('relationship_with_teachers');?></td>
        ...
        <?php $select_subject_with_class_id  =   $this->crud_model->get_subjects_by_class($class_id);
           ...
           ?>
			...
			<?php echo form_open(base_url() . 'admin/marks/'. $exam_id . '/' . $class_id);?>
						<tr>
											<td>
												<?php echo $class_subject_exam_student['affective_areas'];?>
											</td>
											<td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['creativity'];?>" name="creativity_<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_score_change()" onkeyup="AddInputs()">
											</td>
											  <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['honesty'];?>" name="honesty_<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_score_change()" onkeyup="AddInputs()">
											</td>
											  <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['neatness'];?>" name="neatness_<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_score_change()" onkeyup="AddInputs()">
											</td>
                                            <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['punctuality'];?>" name="punctuality_<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_score_change()" onkeyup="AddInputs()">
											</td>
											  <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['relationship_with_peers'];?>" name="relationship_with_peers<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_score_change()" onkeyup="AddInputs()">
											</td>
                                            <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['relationship_with_teachers'];?>" name="relationship_with_teachers<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_score_change()" onkeyup="AddInputs()">
											</td>
