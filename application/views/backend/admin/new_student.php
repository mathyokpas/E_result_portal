...
<div class="panel panel-info">
                ...
                <?php echo form_open(base_url() . 'admin/new_student/create/' , array('class' => 'form-horizontal form-groups-bordered', 'enctype' => 'multipart/form-data'));?>
				<div class="form-group"> 
  <div class="col-sm-12 text-center">
    <input type="file" name="userfile" onChange="readURL(this);" style="color:red">

    <img id="blah" 
         src="<?php echo base_url(); ?>uploads/default_avatar.jpg" 
         alt="your image" 
         height="150" 
         width="150" 
         style="border:1px dotted red; margin-top:10px;">
  </div>
</div>
				...
				<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('application_number');?></label>
                    <div class="col-sm-12">
							<input type="text" class="form-control" name="application_number" required autofocus>
						</div>
					</div>
		...
		<a href="<?php echo base_url();?>admin/classes/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
					...
					<div class="form-group">
    <label class="col-md-12" for="example-text"><?php echo get_phrase('session / examination');?></label>
    <div class="col-sm-12">
        <select name="exam_id" class="form-control select2" style="width:100%" required>
            <option value=""><?php echo get_phrase('select');?></option>
            <?php 
                // Fetch all sessions/exams from the exam table
...
<div class="form-group">
  <label class="col-md-9" for="example-text">
    <?php echo get_phrase('transport_route'); ?> <small>(<?php echo get_phrase('optional'); ?>)</small>
  </label>
  <div class="col-sm-12">
    ...
    <a href="<?php echo base_url(); ?>admin/transport/">
      <button type="button" class="btn btn-info btn-circle btn-xs mt-2">
