    ...
    <li class="<?php if ($page_name == 'invoice') echo 'active'; ?> ">
                <a href="<?php echo base_url(); ?>student/invoice">
                    <i class="fa fa-credit-card p-r-10"></i>
                        ...
                        <span class="hide-menu"><?php echo get_phrase('check_result'); ?></span>
                </a>
            </li> 
            ...
            <li class="<?php if ($page_name == 'invoice') echo 'active'; ?> ">
                <a href="<?php echo base_url(); ?>student/invoice">
                    <i class="fa fa-credit-card p-r-10"></i>
                        ...
                        <span class="hide-menu"><?php echo get_phrase('view_events'); ?></span>
                </a>
            </li> 
            <li class="<?php if ($page_name == 'invoice') echo 'active'; ?> ">
                <a href="<?php echo base_url(); ?>student/invoice">
                    <i class="fa fa-credit-card p-r-10"></i>
                        ...
                        <span class="hide-menu"><?php echo get_phrase('check_health_status'); ?></span>
                </a>
            </li> 
            <li class="<?php if ($page_name == 'invoice') echo 'active'; ?> ">
                <a href="<?php echo base_url(); ?>student/invoice">
                    <i class="fa fa-credit-card p-r-10"></i>
                        ...
                        <span class="hide-menu"><?php echo get_phrase('application_status'); ?></span>
                </a>
            </li> 
            <li class="<?php if ($page_name == 'invoice') echo 'active'; ?> ">
                <a href="<?php echo base_url(); ?>student/invoice">
                    <i class="fa fa-credit-card p-r-10"></i>
                        ...
                        <span class="hide-menu"><?php echo get_phrase('set_/_mark_CBT'); ?></span>
                </a>
            </li> 
