	...
	<div class="col-sm-12">
		<div class="panel panel-info">
            ...
            <div class="canvas_div_pdf">
                ...
                <table width="1000">
                          <tr>
                            <td class="pull-left"><a class="logo" href="#"><img src="<?php echo base_url();?>uploads/logo.png" width="150" height="150" style="border-radius:50%;" alt="home" /></td>
                            <td>
          ...
          10 Mentors Close, Old Bari Road, Beside Baptist Church, <br>Jigo, Bwari, ABUJA. 
              
 <br/>
                                <i class="fa fa-envelope"></i>  E-MAIL: mentorsinternationalacademy@gmail.com: <i class="fa fa-phone"></i><br> TEL: 09074998826, 08067187328, 08160402212 </p>	
                            </td>
...
?>
    					...
    					<table cellpadding="0" cellspacing="0" border="1" class="table" style="color: #00a3cc; font-family:calibri;  font-weight:bold; border-color: #00a3cc;">
								<thead style="font-size:18px; border-color: #00a3cc;">
									...
									<tr syle="font-size:24px;">
										<td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;" style="font-size:18px;"><?php echo get_phrase('subject');?></td>
										<td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo get_phrase('1st C.A ');?></td>
										<td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo get_phrase('2nd C.A');?></td>
  <td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo get_phrase('3rd C.A ');?></td>
										<td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo get_phrase('Notes/Assignments');?></td>
										
										<td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo get_phrase('exam score');?></td>
                                        <td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo get_phrase('total score');?></td>
                                        <td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo get_phrase('grade');?></td>
  ...
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo get_phrase('comment');?></td>
									</tr>
								</thead>
                    				<tbody style="color: #00a3cc; font-family:calibri;  font-weight:bold; border:1px;">
        ...
        <?php $select_subject_with_class_id  =   $this->crud_model->get_subjects_by_class($class_id);
           ...
           ?>
			...
			<?php if($general_select['total_score']>0){?>
						<tr style="font-size: 18px; border:1px;">
											<td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;" style="font-size:15px;">
												<?php echo $class_subject_exam_student['name'];?>
											</td>
											<td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo $general_select['class_score1'];?>
											</td>
											  <td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo $general_select['class_score2'];?>
											</td>
											<td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo $general_select['class_score3'];?>
											</td>
											  <td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo $general_select['class_score4'];?>
											</td>
											  
											  <td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;"><?php echo $general_select['exam_score'];?>
											</td>
                                            <td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;">
								            <?php echo $general_select['total_score'];?>
                                            <td style="padding-top: 1px;
  padding-bottom: 1px;
  padding-left: 1px;
  padding-right: 1px;">
  <?php
$total_score = $general_select['exam_score'] +  $general_select['class_score1'] +  $general_select['class_score2'] +  $general_select['class_score3'] +  $general_select['class_score4'];
  ...
  padding-right: 1px;">
       ...
       <?php };
        ...
        ?>
                       ...
                       <table>
    <tr>
        <td style="color: #00a3cc; font-size: 20px; padding: 5px; border: 1px solid #00a3cc;" style="padding-right: 20px;">Teacher's Comment</td>
        <td style="color: #00a3cc; font-size: 20px; padding: 5px; border: 1px solid #00a3cc;" colspan="6" style="padding-left: 40px;"><?php echo $general_select['teacher']; ?></td>
    </tr>
    <tr>
        <td style="color: #00a3cc; font-size: 20px; padding: 5px; border: 1px solid #00a3cc;" style="padding-right: 20px;">School Administrator's Comment</td>
        <td style="color: #00a3cc; font-size: 20px; padding: 5px; border: 1px solid #00a3cc;" colspan="2" style="padding-left: 40px;"><?php echo $general_select['admin']; ?></td>
    </tr>
     <tr>
        <td style="color: #00a3cc; font-size: 20px; padding: 5px; border: 1px solid #00a3cc;" style="padding-right: 20px;">School Administrator's Signature</td>
        <td style="color: #00a3cc; font-size: 20px; padding: 5px; border: 1px solid #00a3cc;" colspan="2" style="padding-left: 40px;"><img src="<?php echo base_url();?>uploads/adminsign.jpg" width="150" height="50" alt="home" /></td>
    </tr>
</table>     
